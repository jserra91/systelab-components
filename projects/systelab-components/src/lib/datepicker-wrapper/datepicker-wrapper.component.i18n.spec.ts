...
const enterText = (fixture: ComponentFixture<DatepickerTestComponent> | ComponentFixture<WrapperDatepicker>, text: string) => {
...
describe('Systelab ES DatepickerComponent, check translations', () => {
	let fixture: ComponentFixture<WrapperDatepicker>;
	...
	beforeEach(() => {
		fixture = TestBed.createComponent(WrapperDatepicker);
