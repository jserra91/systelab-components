...
describe('DataTransformerService Test', () => {
	let dataTransformerService: WrapperDataTransformerService;
	...
	beforeEach(() => {
		TestBed.configureTestingModule({
			...
			providers: [
				WrapperDataTransformerService
			]
		});
		dataTransformerService = TestBed.inject(WrapperDataTransformerService);
	});
